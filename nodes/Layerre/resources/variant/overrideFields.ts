...
export const layerOverrideFields: INodeProperties[] = [
	{
		...
		required: true,
		description:
			'The layer to override. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
	},
	{
		...
		options: [
			...
			},
			{
				...
				description:
					'Override the image opacity (0.0 = transparent, 1.0 = opaque, for image layers)',
			},
			{
			...
			},
			{
				...
				description:
					'Override the font weight (for text layers). Use values like "bold", "normal", or numeric values like "400", "700".',
			},
			{
